...
<table border="1" cellpadding="5" width="800">
	<tr>
		...
		<form action="book.php" method="post">
			<h3>Make booking</h3>
			<p><input checked="checked" name="item" type="radio" value="Helande" /> Helande   |
			<input name="item" type="radio" value="Mindfulness" />Mindfulness   |
			<input name="item" type="radio" value="Kaffe eller Te" />Kaffe eller Te    | 
			<input name="item" type="radio" value="Meditation" />Meditation   
			<input name="item" type="radio" value="Jacuzzi + Bastu" />Jacuzzi + Bastu  |
			<input name="item" type="radio" value="Lunch" />Lunch |
			<input name="item" type="radio" value="Övernattning" />Övernattning  |
			<input name="item" type="radio" value="Yoga" />Yoga </p>
		...
		<!-- end section for delete and cancel -->
	</tr>
</table>
<?php
/* draws a calendar */
